...
export default function SettingsPage() {
  ...
  if (!user) {
    return (
      <main className="mx-auto flex min-h-[100dvh] max-w-md flex-col items-center justify-center gap-2 px-4">
  ...
  return (
    <main className="mx-auto flex min-h-[100dvh] max-w-md flex-col gap-6 px-4 py-12">
